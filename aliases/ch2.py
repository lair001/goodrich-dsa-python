...
ch2_aliases = {
    ...
    "ch2_ex7_sc1": os_path.join("solutions", "exercises", "R", "ch2", "ex7", "initialize_balance"),
    ...
    "ch2_ex27_sc1": os_path.join("solutions", "exercises", "C", "ch2", "ex27", "efficient_range_contains")
}